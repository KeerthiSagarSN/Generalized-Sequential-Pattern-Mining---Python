...
#class candidate_gen:
'''    
def __init__(self,k,seq_k):

self.k = k
self.seq_k = seq_k


def candidate_gen(self,k,seq_k):
...
seq_k_1 = deepcopy(singleton_arr)
...
if k == 1: # Special rule for candidate generation
   new_seq_k_pruned = seq_k_1
...
#self.new_seq_k = new_seq_k
#return self.new_seq_k                
        
        
#    def candidate_prune(self,new_seq_k,seq_k): # Candidate pruning
new_seq_k_pruned = []
